module.exports = {
  ...
  "description": {
    "full": "Replaces a single document within the collection based on the filter.",
    "summary": "Replaces a single document within the collection based on the filter.",
    "body": ""
  },
  "isPrivate": false,
  "isConstructor": false,
