...
const $dropIndexes = Collection.prototype.dropIndexes;
const $indexes = Collection.prototype.indexes;
...
class LegacyCollection {
  ...
  // overloads to modify default behavior
  async drop() {
    try {
  ...
  async indexes() {
    try {
      let result = await $indexes.call(this);
      return result;
    } catch (e) {
      return [];
    }
