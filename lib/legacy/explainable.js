...
const Explainable = (function() {
  ...
  function constructor(collection, verbosity) {
    ...
    this.help = function() {
      console.log('Explainable operations');
      console.log('\t.aggregate(...) - explain an aggregation operation');
      console.log('\t.count(...) - explain a count operation');
      console.log('\t.distinct(...) - explain a distinct operation');
      console.log('\t.find(...) - get an explainable query');
      console.log('\t.findAndModify(...) - explain a findAndModify operation');
      console.log('\t.group(...) - explain a group operation');
      console.log('\t.remove(...) - explain a remove operation');
      console.log('\t.update(...) - explain an update operation');
      console.log('Explainable collection methods');
      console.log('\t.getCollection()');
      console.log('\t.getVerbosity()');
      console.log('\t.setVerbosity(verbosity)');
