...
function setupPlugins(_plugins, context) {
  return co(function*() {
...
// NOTE: skipping these for now since they require additional setup
describe.skip('BAAS Helper tests', () => {
