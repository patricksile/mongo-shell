module.exports = {
  "tags": [
    ...
    {
      "type": "param",
      "string": "{object} [writeConcern] The level of write concern to apply to this operation. The ``writeConcern`` document uses the same fields as the `getLastError` command.",
      "name": "[writeConcern]",
